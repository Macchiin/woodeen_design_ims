...
<head>
    ...
    <title>Edit Product - Woodeen Design</title>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form action="/wooden_design_ims/products/edit/<?php echo htmlspecialchars($product['product_id']); ?>" method="POST" id="productForm">
                            <!-- Basic Information -->
                            <div class="row mb-4">
                                <div class="col-12">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="current_stock" name="current_stock" 
                                               min="0" value="<?php echo htmlspecialchars($product['current_stock']); ?>" 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" id="unit_price" name="unit_price" 
                                                   step="0.01" min="0.01" value="<?php echo htmlspecialchars(number_format($product['unit_price'], 2, '.', '')); ?>" 
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="reorder_level" name="reorder_level" 
                                               min="0" value="<?php echo htmlspecialchars($product['reorder_level']); ?>" 
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="description" name="description" rows="4" 
                                                  placeholder="Enter product description, specifications, or additional notes..."><?php echo htmlspecialchars($product['description']); ?></textarea>
